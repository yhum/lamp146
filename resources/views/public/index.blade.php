...
<link type="text/css" rel="stylesheet" href="/b/plugins/uploadify/uploadify.css">
...
<body>
            ...
            <div id="mws-navigation">
                <ul>
                    <li>
                       ...
                       <li>
                        <a href="#"><i class="icon-file"></i> 权限管理</a>
                        <ul class="closed">
                            <li><a href="">权限添加</a></li>
                            <li><a href="">权限列表</a></li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="closed">
                            <li><a href="{{ url('/admin/sort/create') }}">分类添加</a></li>
                            <li><a href="{{ url('/admin/sort') }}">分类列表</a></li>
                        </ul>
                    </li>
    ...
    <script src="/b/plugins/uploadify/jquery.uploadify.min.js"></script>
<!--    <script src="/b/plugins/uploadify/uploadify.swf"></script>-->
